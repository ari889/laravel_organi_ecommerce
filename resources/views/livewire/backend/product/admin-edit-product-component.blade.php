                    ...
                    <div class="row">
                        <div class="col-xl-9 col-md-7">
                            ...
                            <div class="mb-3">
                                ...
                                <div wire:ignore>
                                    <textarea id="description" cols="30" rows="10" class="form-control" wire:model="description" placeholder="Enter product description"></textarea>
                                </div>
                                @error('description')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <textarea id="short_description" cols="30" rows="5" class="form-control" wire:model="short_description" placeholder="Enter product short description"></textarea>
                                </div>
                        ...
                        <div class="col-xl-3 col-md-5">
                            <div class="mb-3" wire:ignore>
                                ...
                                <input type="file" class="dropify" id="product_image" wire:model.lazy="newImage" data-height="300" data-max-file-size="3M" data-allowed-file-extensions="jpg png jpeg gif" data-default-file="{{ asset('storage/'.json_decode($image)[1]) }}">
                                @error('newImage')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" id="images" wire:model="newImages" class="form-control @error('newImages') is-invalid @enderror" multiple>
                                @if($newImages)
                                <div class="row mt-3">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-sm-6">
                                        <img src="{{ asset('storage/'.$image) }}" class="img-fluid py-2" alt="">
                                    </div>
                                    @endforeach
                                </div>
                                @endif
