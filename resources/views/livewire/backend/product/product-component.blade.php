        ...
        <div class="card-body">
            <div class="border p-4 rounded">
                <div class="card-title d-flex align-items-center">
                    ...
                    <h5 class="mb-0 text-info">Products</h5>
                    <a href="{{ route('admin.addproduct') }}" class="btn btn-success btn-sm ms-auto">Add Product</a>
                </div>
                <hr>
                <div class="col-md-12">
                    <form method="POST" id="form-filter">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <input type="text" id="sku" class="form-control" placeholder="Shop keeping unit">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
    ...
    <script>
        ...
        $(document).ready( function () {
            table = $('#product_table').DataTable({
                ...
                "ajax" : {
                    "url" : "{{ route('admin.getallproducts') }}",
                    "type" : "POST",
                    "data" : function(data){
                        data._token   = _token;
                        data.name     = $('#form-filter #name').val();
                        data.sku      = $('#form-filter #sku').val();
