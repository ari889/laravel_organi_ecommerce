    ...
    <div class="card radius-10">
        <div class="card-body">
            ...
            <div class="table-responsive">
                <form mdthod="POST" id="form-filter">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                ...
                <table class="table align-middle mb-0" id="orders_table">
    ...
    <script>
        ...
        $(document).ready( function () {
            table = $('#orders_table').DataTable({
                ...
                "ajax" : {
                    "url" : "{{ route('admin.getallorders') }}",
                    "type" : "POST",
                    "data" : function(data){
                        data._token   = _token;
                        data.order_id = $('#form-filter #order_id').val();
                ...
                "buttons" : [
                    ...
                    },
                    {
                        ...
                        customize: function (doc) {
                            doc.content[1].table.widths = ['5%', '20%', '10%', '7%', '5%', '5%', '10%', '18%', '10%', '10%'];
        ...
        $(document).on('click', '.delete_data', function(e){
            ...
            Swal.fire({
                title: 'Are you sure to delete order id '+id+'?',
         ...
         */
         ...
         $(document).on('click', '#bulk_action_delete_all', function(){
            ...
            if(ids.length == 0){
                ...
                let url = '{{ route("admin.order.bulk.delete") }}';
