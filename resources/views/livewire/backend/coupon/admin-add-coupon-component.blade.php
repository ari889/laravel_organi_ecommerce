        ...
        <div class="card-body">
            <div class="border p-4 rounded">
                <div class="card-title d-flex align-items-center">
                    ...
                    <h5 class="mb-0 text-info">Add Coupon</h5>
                ...
                <form wire:submit.prevent="addCoupon">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="expiry_date" class="form-control @error('expiry_date') is-invalid @enderror" placeholder="Enter product name" wire:model="expiry_date">
                        @error('expiry_date')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
